            ...
            >
              <div style={{ marginBottom: '1rem' }}>
                ...
                <p style={{ color: '#666', fontSize: '0.9rem' }}>
                  ⏰ {formatHora(clase.fechaHora)}
                </p>
              </div>

              <div
                style={{
                  backgroundColor: getOcupacionColor(clase.cupoUsado, clase.cupoMaximo),
                  color: 'white',
                  padding: '1rem',
                  borderRadius: '6px',
                  textAlign: 'center',
              ...
              >
                <div style={{ fontSize: '1.8rem', fontWeight: 'bold' }}>
                  {clase.cupoUsado} / {clase.cupoMaximo}
                </div>
                <div style={{ fontSize: '0.85rem', opacity: 0.9 }}>
                  {clase.cupoMaximo - clase.cupoUsado} espacio(s) disponible(s)
                </div>
              </div>
              ...
              <div style={{ fontSize: '0.9rem', color: '#666' }}>
                ...
                ) : clase.cupoUsado >= clase.cupoMaximo * 0.8 ? (
              ...
              <div style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid #eee' }}>
                <p style={{ fontSize: '0.85rem', color: '#999', margin: 0 }}>
                  Educadora: <strong>{clase.empleado?.persona?.nombres || 'No asignada'}</strong>
                </p>
              </div>
            </div>
          ))}
